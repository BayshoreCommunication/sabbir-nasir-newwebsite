...
const GlobalHeroSection = ({ image, titleH1, titleH2, slug }: any) => {
  return (
    <>
      <div className="relative w-full bg-black bg-opacity-85 min-h-[300px]  md:min-h-[550px]">
        <Image
          src={`${image}`}
          alt={titleH1}
          layout="fill"
          objectFit="cover"
          className="z-0 image-cover image-top md:object-center lg:object-left"
          priority
        />

        <div className="absolute inset-0 z-20">
          <div className=" flex flex-col justify-center items-center  h-full -ml-0 md:-ml-[30%]">
